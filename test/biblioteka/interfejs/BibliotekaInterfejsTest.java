...
public abstract class BibliotekaInterfejsTest {
	...
	void testVratiSveKnjige() {
		...
		k.setIsbn("12345");
		biblioteka.dodajKnjigu(k);
		//posto smo rekli da get metode ne testiramo, i ovu smo realno mogli da iskuliramo al ajde
	...
	void testPronadjiKnjigu() {
       ...
       assertTrue(rezultat.contains(k1)); //zbog ove contains metode sam stavljala onaj isbn gore jer contains gleda equals, jasno
       assertTrue(rezultat.contains(k2));
    	// bilo bi dobro npr da smo tamo u setUp metodu ubacili par knjiga da ne moram po testovima da kucam	   
	}
}
